...
public class MetamodelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case MetamodelPackage.LOG_DOCUMENT: {
			...
			if (result == null)
				result = caseDocument(logDocument);
			if (result == null)
		...
		case MetamodelPackage.MEMBER: {
			...
			if (result == null)
				result = caseINamedElement(member);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case MetamodelPackage.BASE_ENTITY: {
			...
			if (result == null)
				result = caseEntity(baseEntity);
			if (result == null)
				result = caseMember(baseEntity);
			if (result == null)
				result = caseINamedElement(baseEntity);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Business Key</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Business Key</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBusinessKey(BusinessKey object) {
		return null;
	}
